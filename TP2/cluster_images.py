...
if __name__ == "__main__":
    ...
    if args.images_dir:
        ...
        os.listdir('C:/Users/Vincent/Downloads/Latin_1168_btv1b8496559r')
        path = "";
        for (dirpath, dirnames, filenames) in walk('C:/Users/Vincent/Downloads/Latin_1168_btv1b8496559r'):
            path = dirpath
            for i in filenames:
                images_path_list.append(path+i)
                print(str(filenames))
    ...
    for i in images_path_list:
        print(i)
        n = extract_features(Image.open(i))
        data.append(n)
